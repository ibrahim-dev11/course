-- ==========================================
-- پرۆژەی دەنگدان - Course Poll System
-- ==========================================

CREATE DATABASE IF NOT EXISTS course_poll CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE course_poll;
...
INSERT INTO polls (title, description, is_active) VALUES (
    ...
    'Flutter بۆ فرۆنت ئێند + Laravel بۆ باک ئێند و ',
    1
);
